...
final List<Puzzle> seedPuzzles = [
  ...
  Puzzle(
    theme: 'Zombie',
    levelNumber: 3,
    storyText: 'You move deeper into the lab. A terminal flickers with a security question tied to chemical stability.',
  ...
  Puzzle(
    theme: 'Zombie',
    levelNumber: 4,
    storyText: 'The next chamber contains broken equipment and chemical spills. Time is running out.',
  ...
  Puzzle(
    theme: 'Time Travel',
    levelNumber: 1,
    storyText: 'The time machine is broken. You must collect all 10 parts to restore it and return home.',
